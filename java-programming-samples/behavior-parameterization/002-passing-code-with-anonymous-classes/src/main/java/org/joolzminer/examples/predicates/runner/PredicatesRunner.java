...
public class PredicatesRunner {
	...
	public static void main(String[] args) {
		// Filter Green Apples
		System.out.println(PredicatesRunner.filterApples(apples, new ApplePredicate() {
		...
		PredicatesRunner.prettyPrintAppleInventory(apples, new AppleFormatter() {
			
			@Override
			public String accept(Apple apple) {
				return "A " + apple.getColor() + " apple that weighs " + apple.getWeight() + " grams.";
			}
		});
	}
}
