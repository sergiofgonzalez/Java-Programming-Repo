...
public class StarbuzzCoffeeDecoratorTest {
	...
	public void testHouseBlendDoubleMochaSoyLatteWithWhip() {
		...
		assertThat(beverage.getDescription(), is(equalTo("House Blend Coffee, Mocha, Mocha, Soy, Whip")));
	...
	public void testEspressoNoCondiments() {
		...
		assertThat(beverage.getDescription(), is(equalTo("Espresso Coffee")));
	...
	public void testDarkRoastDoubleMochaSoyLatteWithWhip() {
		...
		assertThat(beverage.getDescription(), is(equalTo("Dark Roast Coffee, Mocha, Mocha, Soy, Whip")));
	...
	public void testHouseBlendWithSoyMochaAndWhip() {
		...
		assertThat(beverage.getDescription(), is(equalTo("House Blend Coffee, Soy, Mocha, Whip")));
